...
HD_PWD='C:/Users/ianse/OneDrive/Documents/SCHOOL/Winter 24/ECEN 340/integrator/integrator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log integrator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source integrator.tcl -notrace
