...
HD_PWD='C:/Users/ianse/OneDrive/Documents/SCHOOL/Winter 24/ECEN 340/test/vivado_integrator/integrator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log int_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source int_top.tcl
